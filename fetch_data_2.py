...
def main():
    ...
    # Input parameters
    data_type = 'sentinel-2-l2a'  # Options: 'sentinel-1-grd', 'sentinel-2-l2a', 'sentinel-2-l1c'
    bbox_coords = (12.44693, 41.870072, 12.541001, 41.917096) # (longitude and latitude coordinates of lower left and upper right corners)
    time_range = ['2024-08-07T00:00:00Z', '2024-10-07T23:59:59Z']
    evalscript_name = 'lai'
